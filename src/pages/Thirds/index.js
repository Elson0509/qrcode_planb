    ...
    return (
        <View style={[styles.container]}>
            ...
            <FlatList
                ...
                renderItem={(obj) => {
                    return (
                        <TouchableOpacity style={styles.menuItem} onPress={() => { props.navigation.navigate(`Third${obj.item.screen}`, { user: user }) }}>
                            <View style={[styles.menuIcon, { backgroundColor: Constants.backgroundColors['Thirds'] }]}>
