...
const DOBInputBox = (props) => {
  ...
  return (
    <View style={styles.box}>
      <Text style={[styles.labelStyle, { color: props.colorLabel || 'black', fontFamily: THEME.FONTS.r900 }]}>{props.text}</Text>
