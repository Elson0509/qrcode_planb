        ...
        >
          <View style={styles.centeredView}>
              <View style={styles.modalView}>
                  <Text style={styles.modalTitle}>Selecione o condo:</Text>
                  <FlatList
                    data={props.condos}
                    renderItem={(obj)=>{
                      return <TouchableOpacity 
                                key={obj.item.id} 
                                onPress={()=> {props.selectCondoHandler(obj.item)}}
...
export default ModalSelectCondo;